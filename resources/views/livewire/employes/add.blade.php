            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="form-group flex-grow-1 mr-2">
                        <label for="newEmploye.nom">Nom</label>
                    ...
                    <div class="form-group flex-grow-1">
                        <label for="newEmploye.prenom">Prénom</label>
                        <input type="text" class="form-control @error('newEmploye.prenom') is-invalid @enderror" id="newEmploye.prenom" placeholder="Prénom de l'employé">
